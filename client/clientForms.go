...
func getShortQuestions(questions []Question) []QuestionShort {

	var shortQuestions []QuestionShort
	for _, q := range questions {
		shortQuestions = append(shortQuestions, QuestionShort{ID: q.ID, Name: q.Name})
	}
